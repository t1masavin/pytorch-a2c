...
def get_args():
    ...
    parser.add_argument('--log-dir', type=str, default='/home/tims/work/myprojects/exemples/AC/A2C/a2c/log',
                        help='log directory for Tensorboard')
    parser.add_argument('--seed', type=int, default=12, metavar='SEED',
                        help='random seed')
    parser.add_argument('--max-grad_norm', type=float, default=0.5, metavar='MAX_GRAD_NORM',
    ...
    parser.add_argument('--rollout-size', type=int, default=50, metavar='ROLLOUT_SIZE',
                        help='rollout size')
    ...
    parser.add_argument('--icm-beta', type=float, default=1., metavar='ICM_BETA',
                        help='beta for the ICM module')
    parser.add_argument('--value-coeff', type=float, default=0.5, metavar='VALUE_COEFF',
                        help='value loss weight factor in the A2C loss')
    parser.add_argument('--entropy-coeff', type=float, default=0.02, metavar='ENTROPY_COEFF',
